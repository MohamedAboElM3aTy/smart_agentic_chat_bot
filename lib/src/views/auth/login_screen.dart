...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _submit() async {
    ...
    await ref.read(authControllerProvider.notifier).signIn(email: _emailCtrl.text.trim(), password: _passwordCtrl.text);
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(color: context.adaptiveTextSecondary, fontSize: 15),
                      ...
                      children: [
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: 'Email',
                            prefixIcon: Icon(Icons.email_outlined, color: context.adaptiveTextMuted),
                          ),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            labelText: 'Password',
                            prefixIcon: Icon(Icons.lock_outlined, color: context.adaptiveTextMuted),
                ...
                Center(
                  child: Row(
                    ...
                    children: [
                      Text("Don't have an account? ", style: TextStyle(color: context.adaptiveTextSecondary)),
                      TextButton(onPressed: () => context.pushRoute(const SignupRoute()), child: const Text('Sign Up')),
                    ],
                  ),
                ),
              ],
